...
file.cmdbase <- paste0("../data/GIST/GIST CommandFile_template.txt")
file.obsts <- paste0("../data/GIST/updated_TS.csv")
file.predprey <- paste0("..data/GIST/predprey_pairs.csv")
file.basevul <- paste0("..data/GIST/GIST Vulnerabilities.csv")
